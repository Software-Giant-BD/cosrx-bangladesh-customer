...
@section('main')
    <main class="main-content">
        <section class="section-space page-header-area">
            <div class="container">
                    ...
                    <div class="col-lg-7">
                        ...
                        <div class="tab-content" id="product-details-nav-tabContent">
                            <div class="tab-pane" id="specification" role="tabpanel"
                                ...
                                <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Eius velit corporis quo
                                    voluptate culpa soluta, esse accusamus, sunt quia omnis amet temporibus sapiente harum
                                    quam itaque libero tempore. Ipsum, ducimus. lorem</p>
                            </div>
