            ...
            <div class="row mb-n4 mb-sm-n10 g-3 g-sm-6">
                    ...
                    <div class="product-item product-st2-item">
                        <div class="product-thumb">
                            <a class="d-block" href="product-details.html">
                                <img src="{{ asset('assets/images/shop/1.webp') }}" width="370" height="450"
                                    alt="Image-HasTech">
                            </a>
                ...
                <div class="col-6 col-lg-4 mb-4 mb-sm-9">
                    ...
                    <div class="product-item product-st2-item">
                        <div class="product-thumb">
                            <a class="d-block" href="product-details.html">
                                <img src="{{ asset('assets/images/shop/2.webp') }}" width="370" height="450"
                                    alt="Image-HasTech">
                            </a>
                            <span class="flag-new">new</span>
                        </div>
                ...
                <div class="col-6 col-lg-4 mb-4 mb-sm-9">
                    ...
                    <div class="product-item product-st2-item">
                        <div class="product-thumb">
                            <a class="d-block" href="product-details.html">
                                <img src="{{ asset('assets/images/shop/4.webp') }}" width="370" height="450"
                                    alt="Image-HasTech">
                            </a>
                            <span class="flag-new">new</span>
                        </div>
                ...
                <div class="col-6 col-lg-4 mb-4 mb-sm-9">
                    ...
                    <div class="product-item product-st2-item">
                        <div class="product-thumb">
                            <a class="d-block" href="product-details.html">
                                <img src="{{ asset('assets/images/shop/3.webp') }}" width="370" height="450"
                                    alt="Image-HasTech">
                            </a>
                            <span class="flag-new">new</span>
                        </div>
                ...
                <div class="col-6 col-lg-4 mb-4 mb-sm-9">
                    ...
                    <div class="product-item product-st2-item">
                        <div class="product-thumb">
                            <a class="d-block" href="product-details.html">
                                <img src="{{ asset('assets/images/shop/6.webp') }}" width="370" height="450"
                                    alt="Image-HasTech">
                            </a>
                            <span class="flag-new">new</span>
                        </div>
